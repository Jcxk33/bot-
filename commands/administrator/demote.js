...
module.exports = class demote extends Command {
  ...
  hasPermission(msgObject) {
    const MainServer = msgObject.client.guilds.get("784521928659959860");
  ...
  async run(message, { desiredPlayer }) {
    ...
    if(playerName == playerAuthor){
      sentMessage.edit(`${message.author}, :pensive: You cannot manage yourself sped.`)
      return
    }
